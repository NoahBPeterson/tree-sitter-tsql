digraph Roadmap {
  ...
  include(grammar/table_source_item.dot)
  include(grammar/open_json.dot)
  include(grammar/open_xml.dot)
  include(grammar/rowset_function.dot)
  include(grammar/openquery.dot)
  include(grammar/opendatasource.dot)
  include(grammar/change_table.dot)
  include(grammar/tablesample.dot)
  include(grammar/bulk_option.dot)
  include(grammar/json_declaration.dot)
  include(grammar/schema_declaration.dot)
  include(grammar/full_table_name.dot)
  include(grammar/table_valued_function.dot)
  include(grammar/join_part.dot)
